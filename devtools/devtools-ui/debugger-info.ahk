DebuggerInfo(debugger) {
    ...
    ;     ; varName
    ;     dd.AddText("xs10 yp+30 w100 h20", "Signal Name"),
    ;     dd.AddEdit("ReadOnly w150 h20 x+10", debugger.value["signalName"]),
        
    ;     ; signal type
    ;     dd.AddText("xs10 yp+30 w100 h20", "Signal Type"),
    ;     dd.AddEdit("ReadOnly w150 h20 x+10", debugger.value["signalType"]),
